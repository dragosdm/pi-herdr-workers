...
import { createMailboxTransport, type MailboxTransport, type MailboxDeliveryDisposition } from "../../mailbox/transport.js";
...
async function main() {
	...
	const pending = new Set<Promise<MailboxDeliveryDisposition>>();
